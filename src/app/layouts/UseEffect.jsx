    ...
    return (
        <>
            ...
            <CollapseWrapper>
                <BlockQuote>
                    <p>
                        <code>useEffect</code> помогает отслеживать рендеры
                        нашего приложения. В момент рендера он вызовет
                        переданный ему <code>callback</code>. useEffect() может
                        срабатывать при: каждом ререндере компонента. первом
                        рендере. изменении какой-то зависимости. Демонтаже
                        компонента.
                    </p>
                ...
                <BlockQuote>
                    ...
                    <p>
                        {' '}
                        <code>useEffect(() return ())</code> вызовется при
